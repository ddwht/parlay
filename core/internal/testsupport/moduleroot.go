...
// once here — a boundary scan in the since-deleted editor tree counted two
// levels, which pointed at the module root before the modules merged and one
// level short of it after, so it would have stopped covering core/ without ever
// failing.
//
