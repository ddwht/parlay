...
affects:
  - "@parlay-tool/studio-cli-hooks/surface:no-studio-flag-opt-out"
  - "@parlay-tool/studio-cli-hooks/infrastructure:no-studio-flag-and-config-plumbing"
  - "@parlay-tool/studio-cli-hooks/infrastructure:hook-point-dispatch-at-trio-command-completion"
  - "@parlay-tool/studio-cli-hooks/infrastructure:studio-subprocess-lifecycle"
---
