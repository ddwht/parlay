...
**Source**: @parlay-tool/page-layout-field/add-optional-layout-block-to-the-page-schema
**Caching**: none
...
**Source**: @parlay-tool/page-layout-field/define-the-layout-tree-schema
**Caching**: per-process
**Backward-Compatible**: yes

**Notes**:
- The vocabulary itself comes from adapter registrations (see @parlay-tool/adapter-vocabulary-extension); the tree shape — how vocabulary nodes nest and what shared layout properties are allowed — is owned here.
...
- Adding a new validation rule in this feature or in @parlay-tool/adapter-vocabulary-extension adds a new stable error code in lockstep; the verdict shape stays closed
**Source**: @parlay-tool/page-layout-field/surface-layout-validation-as-a-precheck-contract-for-codegen
**Caching**: none
**Backward-Compatible**: yes
...
- Stable error codes registered by this feature: malformed-layout-block, missing-schema-version, vocabulary-version-mismatch, unknown-component-type, raw-value-where-token-required, wiring-in-layout. Additional codes (unknown-variant, unknown-token, universal-field-redeclared, missing-mode-emit-form) are listed in this feature's intents for completeness but are owned and Verify-cased by sibling features (@parlay-tool/adapter-vocabulary-extension and the page-schema feature).
