...
affects:
  - "@studio-support/domain-model-yaml-migration/surface:migrate-domain-model-dry-run-preview"
  - "@studio-support/domain-model-yaml-migration/infrastructure:migrate-domain-model-command-and-idempotency-guard"
---
