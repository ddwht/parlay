# Errors Schema — authoring digest

Derived from `errors.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `errors.schema.md` in full.
