# Design Spec Schema — authoring digest

Derived from `design-spec.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `design-spec.schema.md` in full.
