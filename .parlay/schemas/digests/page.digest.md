# Page Schema — authoring digest

Derived from `page.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `page.schema.md` in full.
