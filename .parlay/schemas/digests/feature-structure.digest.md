# Feature File Structure — authoring digest

Derived from `feature-structure.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `feature-structure.schema.md` in full.
