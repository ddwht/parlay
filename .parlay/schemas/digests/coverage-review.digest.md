# Coverage Review Schema — authoring digest

Derived from `coverage-review.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `coverage-review.schema.md` in full.
