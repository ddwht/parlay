# Authored Unit Schema — authoring digest

Derived from `authored.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `authored.schema.md` in full.
