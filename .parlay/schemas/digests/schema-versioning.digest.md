# Schema Versioning House Rule — authoring digest

Derived from `schema-versioning.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `schema-versioning.schema.md` in full.
