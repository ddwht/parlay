# Adapter-Set Schema — authoring digest

Derived from `adapter-set.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `adapter-set.schema.md` in full.
