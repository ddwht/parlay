# Layout Schema — authoring digest

Derived from `layout.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `layout.schema.md` in full.
