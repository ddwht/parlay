# Steps Schema — authoring digest

Derived from `steps.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `steps.schema.md` in full.
