# Policies Schema — authoring digest

Derived from `policies.schema.md` at deploy time. Never hand-edit: edit the schema's
...
**This schema is not yet marked up.** Read `policies.schema.md` in full.
