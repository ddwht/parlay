...
`parlay extract-domain-model`, and consumed by every read path
(`parlay extract-domain-model`, `parlay load-domain-model`,
...
re-running `parlay extract-domain-model` regenerates it from feature
