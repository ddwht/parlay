...
24 schemas, 51 error codes, 263 KB of source.
...
- `design-loop-conflicts.schema.md` — This schema documents the YAML shape of the conflicts artifact.
- `design-loop-result.schema.md` — This schema documents the YAML shape of the result artifact.
