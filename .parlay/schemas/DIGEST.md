...
23 schemas, 140 error codes, 309 KB of source.
...
| `surface-region-shared` | Two or more different features contribute fragments to the same `(page, region)`; a sharper variant fires when the collision is on an exact `order` slot. |
