...
// and one definition of what counts as a conflict, and the editor endpoint
// and the CLI both call them.
...
// writes it through the same compare-and-swap save path the editor uses —
